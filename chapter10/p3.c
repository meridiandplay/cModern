 ...
 * Modify poker.c program of Section 10.5 by removing the 
 * num_in_rank, num_in_suit and card_exists arrays and adding a 
 * global hand[NCARDS][2] array that represents the poker hand where 
 * column 0 will store the rank and column 1 will store the suit and 
 * each row is a card 
 *
 */
