 ...
 * Modify poker.c program of ection 10.5 by moving the num_in_rank
 * and num_in_suit arrays into main, which will pass them as 
...
void analyze_hand (int num_in_rank[], int nr, int num_in_suit[], int ns);
