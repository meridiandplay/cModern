/*
 * Chpater 17: Program 1:
 * Modify inventory.c so that the array inventory is allocated
 * dynamically and later reallocated when it fills up. Use malloc
 * to allocate and realloc to increase the size when it is required.
 */
