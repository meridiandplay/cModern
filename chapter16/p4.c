/*
 * Chpater 16: Program 4:
 * Modify inventory.c so that main struct contains a member
 * named price that simbolizes unit price in $ per item.
 * Update the functions accordingly and add a new function
 * that lets the user modify the unit price.
 */
